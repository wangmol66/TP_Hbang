...
!function (a, b) {
    ...
    var d = "mui-pull-top-pocket", e = "mui-pull-bottom-pocket", f = "mui-pull", g = "mui-pull-loading", h = "mui-pull-caption", i = "mui-pull-caption-down", j = "mui-pull-caption-refresh", k = "mui-pull-caption-nomore", l = "mui-icon", m = "mui-spinner", n = "mui-icon-pulldown", o = "mui-block", p = "mui-hidden", q = "mui-visibility", r = g + " " + l + " " + n, s = g + " " + l + " " + n, t = g + " " + l + " " + m, u = ['<div class="' + f + '">', '<div class="{icon}"></div>', '<div class="' + h + '">{contentrefresh}</div>', "</div>"].join(""), v = {init: function (b, c) {
        this._super(b, a.extend(!0, {scrollY: !0, scrollX: !1, indicators: !0, deceleration: .003, down: {height: 50, contentinit: "��������ˢ��", contentdown: "��������ˢ��", contentover: "�ͷ�����ˢ��", contentrefresh: "����ˢ��..."}, up: {height: 50, auto: !1, contentinit: "������ʾ���?", contentdown: "������ʾ���?", contentrefresh: "���ڼ���...", contentnomore: "û�и�������", duration: 300}}, c))
    }, _init: function () {
    ...
    var e = "mui-scrollbar", f = "mui-scrollbar-indicator", g = e + "-vertical", h = e + "-horizontal", i = "mui-active", j = {quadratic: {style: "cubic-bezier(0.25, 0.46, 0.45, 0.94)", fn: function (a) {
        return a * (2 - a)
    }}, circular: {style: "cubic-bezier(0.1, 0.57, 0.1, 1)", fn: function (a) {
        return Math.sqrt(1 - --a * a)
    }}, outCirc: {style: "cubic-bezier(0.075, 0.82, 0.165, 1)"}, outCubic: {style: "cubic-bezier(0.165, 0.84, 0.44, 1)"}}, k = a.Class.extend({init: function (b, c) {
    ...
    var c = "mui-slider", d = "mui-slider-group", e = "mui-slider-loop", f = "mui-slider-indicator", g = "mui-action-previous", h = "mui-action-next", i = "mui-slider-item", j = "mui-active", k = "." + i, l = "." + f, m = ".mui-slider-progress-bar", n = a.Slider = a.Scroll.extend({init: function (b, c) {
        this._super(b, a.extend(!0, {fingers: 1, interval: 0, scrollY: !1, scrollX: !0, indicators: !1, scrollTime: 1e3, startX: !1, slideTime: 0, snap: k}, c)), this.options.startX
    }, _init: function () {
    ...
    var d = "mui-popup", e = "mui-popup-backdrop", f = "mui-popup-in", g = "mui-popup-out", h = "mui-popup-inner", i = "mui-popup-title", j = "mui-popup-text", k = "mui-popup-input", l = "mui-popup-buttons", m = "mui-popup-button", n = "mui-popup-button-bold", e = "mui-popup-backdrop", o = "mui-active", p = [], q = function () {
        ...
        return"undefined" != typeof a ? ("function" == typeof b ? (d = b, b = null, c = null) : "function" == typeof c && (d = c, c = null), u(s(a, b || "��ʾ") + t([c || "ȷ��"]), d)) : void 0
    }, w = function (a, b, c, d) {
        return"undefined" != typeof a ? ("function" == typeof b ? (d = b, b = null, c = null) : "function" == typeof c && (d = c, c = null), u(s(a, b || "��ʾ") + t(c || ["ȡ��", "ȷ��"]), d)) : void 0
    }, x = function (a, b, c, d, e) {
        return"undefined" != typeof a ? ("function" == typeof b ? (e = b, b = null, c = null, d = null) : "function" == typeof c ? (e = c, c = null, d = null) : "function" == typeof d && (e = d, d = null), u(s(a, c || "��ʾ", r(b)) + t(d || ["ȡ��", "ȷ��"]), e)) : void 0
    }, y = function () {
