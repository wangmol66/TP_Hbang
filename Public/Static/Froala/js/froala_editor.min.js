...
!function(a) {
    ...
    b.DEFAULTS = {
        ...
        a.FE.MODULES.node = function(b) {
            ...
            function e(e, f) {
                ...
                if (e.querySelectorAll(a.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length)
                    return !1;
                if (e.querySelectorAll(b.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)").length)
                    return !1;
                if (e.querySelectorAll(a.FE.BLOCK_TAGS.join(",")).length > 1)
                    return !1;
                if (e.querySelectorAll(b.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)").length)
                    return !1;
                var g = c(e);
        ...
        a.FE.MODULES.clean = function(b) {
            function c(a) {
                ...
                for (d = 0; d < e.length; d++)
                    e[d].nodeType != Node.ELEMENT_NODE || b.node.isVoid(e[d]) ? e[d].nodeType == Node.TEXT_NODE && (e[d].textContent = e[d].textContent.replace(/\u200b/g, "").replace(/&/g, "&amp;")) : e[d].textContent.replace(/\u200b/g, "").length != e[d].textContent.length && c(e[d]);
            ...
            function d(a) {
                ...
                if (a.nodeType == Node.TEXT_NODE)
                    return a.textContent.replace(/\&/g, "&amp;").replace(/\</g, "&lt;").replace(/\>/g, "&gt;").replace(/\u00A0/g, "&nbsp;");
            ...
            function l() {
                ...
                if (c.length) {
                    var d = !1;
                    0 == b.$el.get(0).querySelectorAll(".fr-marker").length && (b.selection.save(),
                        d = !0);
        ...
        a.FE.MODULES.helpers = function(b) {
            ...
            function t() {
                return null == w && (w = navigator.platform.toUpperCase().indexOf("MAC") >= 0),
                    w
            }
            function u() {
                b.browser = d()
        ...
        a.FE.MODULES.selection = function(b) {
            ...
            function g() {
                ...
                try {
                    if (f.rangeCount) {
                        var g = e(0)
                            , h = g.startContainer;
                        if (h.nodeType == Node.TEXT_NODE && g.startOffset == (h.textContent || "").length && h.nextSibling && (h = h.nextSibling),
                            ...
                            if (h.childNodes.length > 0 && h.childNodes[g.startOffset]) {
                                for (var j = h.childNodes[g.startOffset]; j && j.nodeType == Node.TEXT_NODE && 0 == j.textContent.length; )
                                    j = j.nextSibling;
                                if (j && j.textContent.replace(/\u200B/g, "") === c().replace(/\u200B/g, "") && (h = j,
                                        i = !0),
                                    !i && h.childNodes.length > 1 && g.startOffset > 0 && h.childNodes[g.startOffset - 1]) {
                                    for (var j = h.childNodes[g.startOffset - 1]; j && j.nodeType == Node.TEXT_NODE && 0 == j.textContent.length; )
                                        j = j.nextSibling;
                    ...
                    for (var g = e(), h = 0; h < g.length; h++) {
                        ...
                        for (var n = [], o = k; o !== l && o !== b.$el.get(0); )
                            n.indexOf(o) < 0 && o.children && o.children.length ? (n.push(o),
                                ...
                                n.push(o)),
                            b.node.isBlock(o) && n.indexOf(o) < 0 && c.indexOf(o) < 0 && (o !== l || j.endOffset > 0) && c.push(o);
                        ...
                        try {
                            ...
                            if (!n) {
                                ...
                                if (b.browser.chrome && i.nextSibling == k)
                                    ...
                                    y && y.style && "block" == b.win.getComputedStyle(y).display && !b.opts.enter == a.FE.ENTER_BR ? (j.setEndAfter(y),
            ...
            function m(c, d, e) {
                ...
                return g && !f && g.nodeType == Node.TEXT_NODE ? e ? (b.spaces.normalize(g),
                        function() {
                            d.setStart(g, 0)
                        }
                ) : (b.spaces.normalize(g),
            ...
            function u() {
                ...
                for (var c = function(b) {
                    ...
                    for (var g = e[f]; !c(g) && !b.node.isBlock(g.parentNode) && !b.$el.is(g.parentNode); )
                        a(g.parentNode).before(g);
                for (var h = b.$el.find('.fr-marker[data-type="false"]'), f = 0; f < h.length; f++) {
                    for (var i = h[f]; !d(i) && !b.node.isBlock(i.parentNode) && !b.$el.is(i.parentNode); )
                            ...
                            if (q) {
                                if (p && p == q)
                                    ...
                                    if (r && ["UL", "OL"].indexOf(r.tagName) >= 0 && (r = null ,
                                            u = !0),
                                        t && ["UL", "OL"].indexOf(t.tagName) >= 0 && (t = null ,
                                            v = !0),
                                            a(m).after(q),
                                        r == t)
                                        ;
                                    else if (null != r || u)
                                        if (null != t || v || 0 != a(r).parentsUntil(b.$el, "table").length)
                                            r && t && 0 == a(r).parentsUntil(b.$el, "table").length && 0 == a(t).parentsUntil(b.$el, "table").length && (a(r).append(a(t).html()),
                                                a(t).remove());
                                        else {
                ...
                !y.nextSibling && z.previousSibling && "BR" == z.previousSibling.tagName && b.node.isElement(y.parentNode) && b.node.isElement(z.parentNode) && b.$el.append("<br>"),
                    l()
            }
            function v(c) {
        ...
        a.FE.MODULES.spaces = function(b) {
                ...
                if (a.firstChild && "PRE" !== a.nodeName && !(["STYLE", "SCRIPT"].indexOf(a.tagName) >= 0)) {
                    for (var e = null , f = null , g = d(f, a); g !== a && "PRE" !== g.nodeName && ["STYLE", "SCRIPT"].indexOf(g.tagName) < 0; ) {
                        if (g.nodeType === Node.TEXT_NODE) {
                            ...
                            if (e && !/ $/.test(e.data) || " " !== h[0] || g.previousSibling && b.node.isVoid(g.previousSibling) && "BR" !== g.previousSibling.tagName || (h = h.substr(1)),
                                !h || 0 == h.length) {
                                g = c(g);
                                continue
                            }
                            ...
                            g.nodeType === Node.ELEMENT_NODE && (b.node.isBlock(g) || b.node.isVoid(g) ? (e && e.data && (b.node.isBlock(g) || "BR" === g.tagName) && (e.data = e.data.replace(/ $/, "")),
                                e = null ) : 0 == g.textContent.length && (e = g));
                        var i = d(f, g);
                        f = g,
                            g = i
                    }
            ...
            function f(c, d) {
                if ("undefined" != typeof c && c || (c = b.$el.get(0)),
                    "undefined" == typeof d && (d = !1),
                    d && e(c),
                    ...
                    if (c.nodeType == Node.ELEMENT_NODE && ["STYLE", "SCRIPT", "HEAD"].indexOf(c.tagName) < 0)
                        for (var g = b.node.contents(c), h = g.length - 1; h >= 0; h--)
                            (g[h].tagName != Node.ELEMENT_NODE || (g[h].getAttribute("class") || "").indexOf("fr-marker") < 0) && f(g[h]);
                        ...
                        (!c.nextSibling || b.node.isBlock(c.nextSibling) || c.nextSibling.nodeType == Node.ELEMENT_NODE && b.win.getComputedStyle(c.nextSibling) && "block" == b.win.getComputedStyle(c.nextSibling).display) && (j = j.replace(/ $/, a.FE.UNICODE_NBSP)),
                        !c.previousSibling || b.node.isVoid(c.previousSibling) || b.node.isBlock(c.previousSibling) || (j = j.replace(/^\u00A0([^ $])/, " $1"),
                        1 !== j.length || 160 !== j.charCodeAt(0) || !c.nextSibling || b.node.isVoid(c.nextSibling) || b.node.isBlock(c.nextSibling) || (j = " ")),
                            j = j.replace(/([^ \u00A0])\u00A0([^ \u00A0])/g, "$1 $2"),
        ...
        a.FE.MODULES.html = function(b) {
            ...
            function d() {
                var c = []
                    ...
                    , e = f();
                e += "," + a.FE.VOID_ELEMENTS.join(","),
                    e += "," + b.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)";
            ...
            function h(d, e) {
                ...
                if (e && (f = 'div class="fr-temp-div"'),
                    ...
                    for (var g = b.node.contents(d.get(0)), h = null , i = 0; i < g.length; i++) {
                        var j = g[i];
                        if (j.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(j) || a(j).is(b.opts.htmlDoNotWrapTags.join(",")) && !a(j).hasClass("fr-marker")))
                            h = null ;
                            ...
                            j.nodeType == Node.TEXT_NODE && 0 == j.textContent.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length ? a(j).remove() : (null == h && (h = a("<" + f + ">"),
                                a(j).before(h)),
                ...
                for (var c = b.node.contents(a), d = c.length - 1; d >= 0; d--)
                    if (c[d].nodeType == Node.TEXT_NODE) {
                        c[d].textContent = c[d].textContent.replace(/(?!^)( ){2,}(?!$)/g, " "),
                            ...
                            c[d].textContent = c[d].textContent.replace(/^[ ]{2,}/g, " "),
                            c[d].textContent = c[d].textContent.replace(/[ ]{2,}$/g, " "),
                        (b.node.isBlock(a) || b.node.isElement(a)) && (c[d].previousSibling || (c[d].textContent = c[d].textContent.replace(/^ */, "")),
                        c[d].nextSibling || (c[d].textContent = c[d].textContent.replace(/ *$/, "")),
                        c[d].previousSibling && c[d].nextSibling && " " == c[d].textContent && (c[d].previousSibling && c[d].nextSibling && b.node.isBlock(c[d].previousSibling) && b.node.isBlock(c[d].nextSibling) ? c[d].textContent = "" : c[d].textContent = "\n"))
                    } else
                        m(c[d])
            }
            function n(a) {
            ...
            function t() {
                b.core.isEmpty() && (null != c() ? 0 === b.$el.get(0).querySelectorAll(f()).length && 0 === b.$el.get(0).querySelectorAll(b.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)").length && (b.core.hasFocus() ? (b.$el.html("<" + c() + ">" + a.FE.MARKERS + "<br/></" + c() + ">"),
            ...
            function y(a, c) {
                ...
                if (!b.opts.useClasses && !c) {
                    ...
                    for (e = 0; e < b.doc.styleSheets.length; e++) {
                        var j, k = 0;
                        try {
                            j = b.doc.styleSheets[e].cssRules,
                            b.doc.styleSheets[e].ownerNode && "STYLE" == b.doc.styleSheets[e].ownerNode.nodeType && (k = 1)
                        } catch (l) {}
                        if (j)
                            for (var m = 0, n = j.length; n > m; m++)
                                if (j[m].selectorText && j[m].style.cssText.length > 0) {
                                    ...
                                    for (var q = 0; q < o.length; q++) {
                                        !o[q].getAttribute("fr-original-style") && o[q].getAttribute("style") ? (o[q].setAttribute("fr-original-style", o[q].getAttribute("style")),
                                            g.push(o[q])) : o[q].getAttribute("fr-original-style") || g.push(o[q]),
                                        h[o[q]] || (h[o[q]] = {});
                                        for (var s = 1e3 * k + f(j[m].selectorText), t = j[m].style.cssText.split(";"), u = 0; u < t.length; u++) {
                                            var v = t[u].trim().split(":")[0];
                                            v.match(i) || (h[o[q]][v] || (h[o[q]][v] = 0,
                                            (o[q].getAttribute("fr-original-style") || "").indexOf(v + ":") >= 0 && (h[o[q]][v] = 1e4)),
                                            s >= h[o[q]][v] && (h[o[q]][v] = s,
                                            t[u].trim().length && (o[q].style[v.trim()] = t[u].trim().split(":")[1].trim())))
                                        }
                                    }
                                }
                    }
                    for (e = 0; e < g.length; e++)
                        if (g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")),
                            ...
                            for (var w = g[e].getAttribute("fr-original-style").split(";"), q = 0; q < w.length; q++)
                                w[q].indexOf(":") > 0 && (g[e].style[w[q].split(":")[0].trim()] = w[q].split(":")[1].trim())
                }
        ...
        a.FE.MODULES.size = function(a) {
            ...
            function d() {
                return a.$wp ? (c(),
                    void (a.$iframe && (a.events.on("keyup", b),
        ...
        a.FE.MODULES.placeholder = function(b) {
            function c() {
                ...
                if (h.length && h[0].nodeType == Node.ELEMENT_NODE) {
                    var i = a(h[0]);
                    b.opts.toolbarInline || (c = b.helpers.getPX(i.css("margin-top")),
        ...
        a.FE.MODULES.edit = function(a) {
            ...
            function d() {
                ...
                a.$tb && a.$tb.addClass("fr-disabled")) : a.$el.is("a") && a.$el.attr("contenteditable", !1),
                    f = !0
            }
            function e() {
                return f
        ...
        a.FE.MODULES.format = function(b) {
            ...
            function e(a, b) {
                var c = a;
                for (var d in b)
                    b.hasOwnProperty(d) && (a += "id" == d ? "#" + b[d] : "class" == d ? "." + b[d] : "[" + d + '="' + b[d] + '"]');
                return c
            }
            function f(a, b) {
            ...
            function h(h, i) {
                if ("undefined" == typeof i && (i = {}),
                    ...
                    while (l.length);b.$el.get(0).normalize();
            ...
            function i(a, c, d, g) {
                ...
                if (a.parents(c).length || "undefined" == typeof c) {
                    ...
                    if (k.is(b.$el) || b.node.isBlock(k.get(0)))
                        return !1;
                    for (; "undefined" == typeof c && !b.node.isBlock(k.parent().get(0)) || "undefined" != typeof c && !f(k.get(0), e(c, d)); )
            ...
            function o(c, d) {
                if (b.selection.isCollapsed()) {
                    ...
                    if (b.node.openTagString(f.get(0)) == '<span style="' + c + ": " + f.css(c) + ';">')
                        if (b.node.isEmpty(f.get(0)))
                            f.replaceWith('<span style="' + c + ": " + d + ';">' + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + "</span>");
                        else {
                            var h = {};
                            h[c] = d,
                                i(e, "span", h, !0),
                                e = b.$el.find(".fr-marker"),
                                e.replaceWith('<span style="' + c + ": " + d + ';">' + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + "</span>")
                        }
                    else
                        b.node.isEmpty(f.get(0)) && f.is("span") ? (e.replaceWith(a.FE.MARKERS),
                            f.css(c, d)) : e.replaceWith('<span style="' + c + ": " + d + ';">' + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + "</span>");
                    b.selection.restore()
                } else {
                    b.selection.save();
                    ...
                    for (d && (o.style = c + ": " + d + ";"),
                        ...
                        for (var r = p.find("span"), k = r.length - 1; k >= 0; k--)
                            m(r[k], c);
                        ...
                        if (s.length) {
                            ...
                            do
                                x = x.parentNode,
                                    a(x).addClass("fr-split"),
                                    t += b.node.closeTagString(x),
                                    u = b.node.openTagString(a(x).clone().addClass("fr-split").get(0)) + u,
                                s.get(0) != x && (v += b.node.closeTagString(x),
                                    w = b.node.openTagString(a(x).clone().addClass("fr-split").get(0)) + w);
                            while (s.get(0) != x);var y = t + b.node.openTagString(a(s.get(0)).clone().css(c, d || "").get(0)) + w + p.css(c, "").get(0).outerHTML + v + "</span>" + u;
                    ...
                    for (k = 0; k < A.length; k++) {
                        var B = a(A[k])
                            , C = a(A[k]).prev();
                        B.get(0).previousSibling == C.get(0) && b.node.openTagString(B.get(0)) == b.node.openTagString(C.get(0)) && (B.prepend(C.html()),
                            C.remove())
                    }
                    b.$el.get(0).normalize(),
                        b.selection.restore()
            ...
            function q(a, c) {
                ...
                if (h && h.nodeType == Node.ELEMENT_NODE && f(h, e(a, c)))
                    return !0;
                var i = g;
                for (i && i.nodeType != Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType == Node.ELEMENT_NODE && i != b.$el.get(0) && !f(i, e(a, c)); )
                    i = i.parentNode;
        ...
        a.FE.MODULES.commands = function(b) {
            ...
            function g() {
                b.events.on("keydown", function(a) {
                    ...
                    return c && "HR" == c.tagName && !b.keys.isArrow(a.which) ? (a.preventDefault(),
                        !1) : void 0
                }),
                    ...
                    b.events.on("mouseup", function(c) {
                        ...
                        d == e && d && "HR" == d.tagName && (d.nextSibling && (b.node.isBlock(d.nextSibling) ? b.selection.setAtStart(d.nextSibling) : a(d).after(a.FE.MARKERS)),
                            b.selection.restore())
                    })
            }
            var h = {
                ...
                insertHR: function() {
                    ...
                    var a = "";
                    b.core.isEmpty() && (a = "<br>",
                    b.html.defaultTag() && (a = "<" + b.html.defaultTag() + ">" + a + "</" + b.html.defaultTag() + ">")),
                        b.html.insert('<hr id="fr-just">' + a);
                    var c = b.$el.find("hr#fr-just");
                    c.removeAttr("id"),
                    b.selection.setAfter(c.get(0)) || b.selection.setBefore(c.get(0)),
                        b.selection.restore()
                },
            ...
            function e(e) {
                ...
                if (b.node.isEmpty(g, !0) && h) {
                    ...
                    i && h || !b.node.isEmpty(g, !0) ? (a(g).before("<li><br></li>"),
                        ...
                        a(g).remove()) : (f = d(g),
                        f.parentNode && "LI" == f.parentNode.tagName ? h ? a(f.parentNode).before("<li>" + a.FE.MARKERS + "<br></li>") : a(f.parentNode).after("<li>" + a.FE.MARKERS + "<br></li>") : j ? a(f).before("<" + j + ">" + a.FE.MARKERS + "<br></" + j + ">") : a(f).before(a.FE.MARKERS + "<br>"),
                        a(g).remove())
            }
            function f(d) {
        ...
        a.FE.MODULES.cursor = function(b) {
            ...
            function i(c) {
                ...
                if (!b.node.isBlock(d) && b.node.isEditable(d)) {
                    ...
                    if (d.nodeType == Node.TEXT_NODE) {
                        ...
                        0 == d.textContent.length ? i && b.opts.keepFormatOnDelete ? a(d).after(a.FE.INVISIBLE_SPACE + a.FE.MARKERS) : 2 != d.parentNode.childNodes.length || d.parentNode != c.parentNode || b.node.isBlock(d.parentNode) || b.node.isElement(d.parentNode) ? (a(d).after(a.FE.MARKERS),
                        ...
                        b.node.isDeletable(d) ? (a(d).after(a.FE.MARKERS),
                            a(d).remove()) : b.events.trigger("node.remove", [a(d)]) !== !1 && (a(d).after(a.FE.MARKERS),
                            a(d).remove())
            ...
            function l(d) {
                ...
                if (!b.node.isBlock(e) && b.node.isEditable(e)) {
                    for (h = b.node.contents(e); e.nodeType != Node.TEXT_NODE && h.length && !b.node.isDeletable(e) && b.node.isEditable(e); )
                        e = h[0],
                            h = b.node.contents(e);
                    e.nodeType == Node.TEXT_NODE ? (a(e).before(a.FE.MARKERS),
                        e.textContent.length && 55357 == e.textContent.charCodeAt(0) ? e.textContent = e.textContent.substring(2, e.textContent.length) : e.textContent = e.textContent.substring(1, e.textContent.length)) : b.node.isDeletable(e) ? (a(e).before(a.FE.MARKERS),
            ...
            function o(c, d, e) {
                ...
                if (null == h)
                    g = b.html.defaultTag(),
                        g && b.node.isElement(c.parentNode) ? a(c).replaceWith("<" + g + ">" + a.FE.MARKERS + "<br></" + g + ">") : a(c).replaceWith("<br/>" + a.FE.MARKERS + "<br/>");
                else {
                    var i = c
                        , j = "";
        ...
        a.FE.MODULES.keys = function(b) {
            function c(a) {
                b.opts.multiLine ? b.helpers.isIOS() || (a.preventDefault(),
                    a.stopPropagation(),
                b.selection.isCollapsed() || b.selection.remove(),
            ...
            function m(h) {
                ...
                if ((b.selection.isFull() && !b.opts.keepFormatOnDelete && !b.placeholder.isVisible() || l && b.placeholder.isVisible() && b.opts.keepFormatOnDelete) && (k || l)) {
                    var m = b.html.defaultTag();
                    if (m ? b.$el.html("<" + m + ">" + a.FE.MARKERS + "<br/></" + m + ">") : b.$el.html(a.FE.MARKERS + "<br/>"),
                            b.selection.restore(),
                            !t(i))
                        return h.preventDefault(),
                            !0
                }
                i == a.FE.KEYCODE.ENTER ? h.shiftKey ? d(h) : c(h) : i != a.FE.KEYCODE.BACKSPACE || r(h) || h.altKey ? i != a.FE.KEYCODE.DELETE || r(h) || h.altKey ? i == a.FE.KEYCODE.SPACE ? g(h) : i == a.FE.KEYCODE.TAB ? j(h) : r(h) || !t(h.which) || b.selection.isCollapsed() || h.ctrlKey || b.selection.remove() : b.placeholder.isVisible() ? (h.preventDefault(),
                    h.stopPropagation()) : f(h) : b.placeholder.isVisible() ? (h.preventDefault(),
            ...
            function n(c) {
                for (var d = 0; d < c.length; d++)
                    ...
                    0 === c[d].textContent.length && a(c[d]).remove()) : c[d].nodeType == Node.ELEMENT_NODE && "IFRAME" != c[d].nodeType && n(b.node.contents(c[d]))
            }
            function o() {
                if (!b.$wp)
                    return !0;
            ...
            function q(c) {
                ...
                c && (c.which == a.FE.KEYCODE.ENTER || c.which == a.FE.KEYCODE.BACKSPACE || c.which >= 37 && c.which <= 40 && !b.browser.msie) && (c.which == a.FE.KEYCODE.BACKSPACE && y || o());
                ...
                for (var d = [], f = 0; f < e.length; f++) {
                    ...
                    j && l && "BR" != j.tagName && !b.node.isBlock(j) && !k && a(l).text().replace(/\u200B/g, "").length > 0 && a(j).text().length > 0 && (b.$el.is(l) && !k && b.opts.enter == a.FE.ENTER_BR && b.browser.msie || (b.selection.save(),
                        a(i).remove(),
                        b.selection.restore()))
                }
                e = [];
                ...
                m(r) && 0 === a(r).find("li").length && !a(r).hasClass("fr-marker") && "IFRAME" != r.tagName && q(r) && (b.selection.save(),
                    n(b.node.contents(r)),
                    b.selection.restore()),
                !b.browser.mozilla && b.html.doNormalize(r) && (b.selection.save(),
                    b.spaces.normalize(),
                    b.selection.restore())
            }
            function r(a) {
            ...
            function u(c) {
                var d = c.which;
                return r(c) || d >= 37 && 40 >= d || !t(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER ? !0 : (z || (A = b.snapshot.get()),
                    clearTimeout(z),
                    void (z = setTimeout(function() {
                        z = null ,
                            b.undo.saveStep()
                    }, Math.max(250, b.opts.typingTimer))))
            }
            function v(a) {
                return r(a) ? !0 : void (A && z && (b.undo.saveStep(A),
                    A = null ))
            }
            function w() {
                z && (clearTimeout(z),
        ...
        a.FE.MODULES.paste = function(b) {
            ...
            function e() {
                b.selection.save(),
                    b.events.disableBlur(),
                    m = null ,
                    n ? n.html("") : (n = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 9999; line-height: 140%;" tabindex="-1"></div>'),
                        b.$box.after(n),
            ...
            function h() {
                ...
                "string" == typeof d && (m = d);
                var e = !1;
                m.match(/(class=\"?Mso|class=\'?Mso|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi) && (e = !0),
                m.indexOf("<body") >= 0 && (m = m.replace(/[.\s\S\w\W<>]*<body[^>]*>([.\s\S\w\W<>]*)<\/body>[.\s\S\w\W<>]*/g, "$1"));
                var h = !1;
                if (m.indexOf('id="docs-internal-guid') >= 0 && (m = m.replace(/^.* id="docs-internal-guid[^>]*>(.*)<\/b>.*$/, "$1"),
                        h = !0),
                        e ? (m = m.replace(/^\n*/g, "").replace(/^ /g, ""),
                    ...
                    "" !== m) {
                    var k = a("<div>").html(m);
                    b.spaces.normalize(k.get(0)),
                        k.find("span").each(function() {
            ...
            function j(c) {
                ...
                for (var g = e.find("> div:not([style]), td > div, th > div, li > div"); g.length && d++ < 100; ) {
                    ...
                    b.html.defaultTag() && "div" != b.html.defaultTag() ? h.replaceWith("<" + b.html.defaultTag() + ">" + h.html() + "</" + b.html.defaultTag() + ">") : h.find("*:last").is("br") ? h.replaceWith(h.html()) : h.replaceWith(h.html() + "<br>"),
            ...
            function d(c) {
                ...
                if (e && a.FE.SHORTCUTS_MAP[f]) {
                    ...
                    if (g && b.opts.shortcutsEnabled.indexOf(g) >= 0) {
                        ...
                        if (g && !i ? h = b.$tb.find('.fr-command[data-cmd="' + g + '"]') : g && i && (h = b.$tb.find('.fr-command[data-cmd="' + g + '"][data-param1="' + i + '"]')),
                                h.length)
                            return c.preventDefault(),
                                c.stopPropagation(),
                                h.parents(".fr-toolbar").data("instance", b),
                            "keydown" == c.type && b.button.exec(h),
                                !1;
                        if (g && b.commands[g])
                            return c.preventDefault(),
                                c.stopPropagation(),
                            "keydown" == c.type && b.commands[g](),
                                !1
                    }
                }
            }
        ...
        a.FE.MODULES.undo = function(a) {
            ...
            function e(b) {
                return !a.undo_stack || a.undoing || a.$el.get(0).querySelectorAll(".fr-marker").length ? !1 : void ("undefined" == typeof b ? (b = a.snapshot.get(),
            ...
            function d(c, d) {
                ...
                b.$tooltip.css("position", ""),
                    ...
                    "static" != a(b.o_doc).find("body").css("position") ? (b.$tooltip.css("margin-left", -a(b.o_doc).find("body").offset().left),
                        b.$tooltip.css("margin-top", -a(b.o_doc).find("body").offset().top)) : (b.$tooltip.css("margin-left", ""),
        ...
        a.FE.MODULES.button = function(b) {
            ...
            function j(c, d) {
                ...
                b.opts.iframe && b.events.$on(b.$win, b._mouseup, k, !0),
                    c.hasClass("fr-popup") ? a.merge(t, c.find(".fr-btn").toArray()) : a.merge(s, c.find(".fr-btn").toArray()),
            ...
            function r() {
                b.opts.toolbarInline ? b.events.on("toolbar.show", p) : (b.events.on("mouseup", p),
                    b.events.on("keyup", p),
                    b.events.on("blur", p),
                    b.events.on("focus", p),
            ...
            (b.opts.toolbarInline || b.opts.toolbarContainer) && (b.shared.buttons || (b.shared.buttons = []),
                s = b.shared.buttons);
            var t = [];
            return b.shared.popup_buttons || (b.shared.popup_buttons = []),
        ...
        a.FE.MODULES.popups = function(b) {
            ...
            function d(d, e, h, i) {
                ...
                b.opts.toolbarInline && l && b.$tb && l.get(0) == b.$tb.get(0) && (c(d, a(b.opts.scrollableContainer)),
                    h = b.$tb.offset().top - b.helpers.getPX(b.$tb.css("margin-top")),
                    e = b.$tb.offset().left + b.$tb.outerWidth() / 2 + (parseFloat(b.$tb.find(".fr-arrow").css("margin-left")) || 0) + b.$tb.find(".fr-arrow").outerWidth() / 2,
                ...
                h && (h -= b.$iframe.offset().top)),
                    l.is(b.$tb) ? b.$tb.css("zIndex", (b.opts.zIndex || 1) + 4) : x[d].css("zIndex", (b.opts.zIndex || 1) + 4),
                e && (e -= j / 2),
            ...
            function s(c) {
                ...
                return {
                    ...
                    _doPlaceholder: function(b) {
                        var c = a(this).next();
                        0 == c.length && a(this).after("<label>" + a(this).attr("placeholder") + "</label>"),
        ...
        a.FE.MODULES.position = function(b) {
            ...
            function d(c, d, e) {
                ...
                if (!b.helpers.isMobile() && b.$tb && c.parent().get(0) != b.$tb.get(0)) {
                    ...
                    g + d + f > a(b.opts.scrollableContainer).offset().top + i && c.parent().offset().top + h > 0 ? (d = h,
            ...
            function e(c, d) {
                var e = c.outerWidth();
                return d + e > a(b.opts.scrollableContainer).width() - 10 && (d = a(b.opts.scrollableContainer).width() - e - 10),
                0 > d && (d = 10),
                    d
            }
            function f(d) {
            ...
            function g(a, c, f, g) {
                ...
                !h || h.is("body") && "static" == h.css("position") || (a && (a -= h.offset().left),
                c && (c -= h.offset().top),
                    "BODY" != h.get(0).tagName ? (a && (a += h.scrollLeft()),
                    c && (c += h.scrollTop())) : "absolute" == h.css("position") && (a && (a += h.position().left),
                    c && (c += h.position().top))),
                ...
                if (c.offsetWidth) {
                    ...
                    if (f.data("sticky-offset") || (f.data("sticky-offset", !0),
                        ...
                        q || f.css("position", ""),
                            ...
                            f.data("bottom", f.hasClass("fr-bottom") ? f.css("bottom") : "auto")
                    }
                    var r = function() {
        ...
        a.extend(a.FE.DEFAULTS, {
            ...
            toolbarButtonsx: ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "fontFamily", "fontSize", "|", "color", "emoticons", "inlineStyle", "paragraphStyle", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "insertHR", "-", "insertLink", "insertImage", "insertVideo", "insertFile", "insertTable", "undo", "redo", "clearFormatting", "selectAll", "html", "applyFormat", "removeFormat"],
