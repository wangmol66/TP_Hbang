                        ...
                        <form action="<?php echo U('save');?>" class="form-horizontal" method="post">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control required" name="title" value="<?php echo ($info["title"]); ?>" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="type_id" class="form-control form-filter select2 input-sm required" data-placeholder="文章分类" multiple>
                                            <option value=""></option>
                                            <?php if(is_array($types)): foreach($types as $k=>$vo): ?><option value="<?php echo ($vo["type_id"]); ?>" <?php if($info['type_id'] == $vo['type_id']){echo 'selected';};?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
                                    <script>
                                        $(function () {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 350px; height: 150px; line-height: 140px;">
