                        ...
                        <form action="<?php echo U('save');?>" class="form-horizontal" method="post">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control required" name="title" value="" type="text" placeholder="文章标题">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="type" class="form-control form-filter select2 input-sm required" data-placeholder="文章分类">
                                            <option value=""></option>
                                            <option value="1">企业大记事</option>
                                            <option value="2">研发新闻</option>
                                            <option value="3">集团信息</option>
                                        </select>
                                    </div>
                                    <script>
                                        $(function () {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea class="form-control" name="remark" rows="3" placeholder="文章摘要"></textarea>
                                    </div>
                                </div>
