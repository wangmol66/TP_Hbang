...
<div class="page-container"> 
          ...
          <div class="portlet">
            <div class="portlet-body">
              <div class="table-container">
                <div class="table-actions-wrapper"> <span> </span> <a  class="btn btn-sm blue add-btn" href="<?php echo U('add');?>"><i class="fa fa-plus"></i> 新增用户 </a> </div>
                <table class="table table-bordered table-striped table-hover" id="datatable">
                  <thead>
                    <tr class="heading" role="row">
	                    ...
	                    <th width="120px">登录次数</th>
	                    <th width="120px">最后登陆时间</th>
	                    <th width="120px">最后登录IP</th>
	                    <th width="100px">状态</th>
	                    <th width="100px">操作</th>
                    </tr>
                    <tr role="row" class="filter">
                        <th><input type="text" class="form-control form-filter input-sm" name="uid"/></th>
  ...
  <script type="text/javascript">
		$(function(){
			datatable_init({
				src: $("#datatable"),
				sAjaxSource: "<?php echo U('User/getLists?pid='.I('get.pid'));?>",
