                  ...
                  <thead>
                    ...
                    <tr role="row" class="filter">
	                    ...
	                    <th><select name="type_id" class="form-control form-filter select2 input-sm">
                      		...
                      		<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["type_id"]); ?>"><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select></th>
	                    <th></th>
	                    <th></th>
	                    <th></th>
