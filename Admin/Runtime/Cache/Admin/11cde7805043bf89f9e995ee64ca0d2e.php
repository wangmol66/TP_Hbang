                        ...
                        <form action="<?php echo U('save');?>" class="form-horizontal" method="post">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="type_id[]" class="form-control form-filter select2 input-sm required" data-placeholder="文章分类" multiple>
                                            <option value=""></option>
                                            <?php if(is_array($types)): foreach($types as $k=>$vo): ?><option value="<?php echo ($vo["type_id"]); ?>"><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
                                    <script>
                                        $(function () {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 200px; line-height: 140px;">
                                            </div>
                                            <div>
                                        ...
                                        <div class="clearfix margin-top-10">
                                            ...
                                            图片格式：gif,png,jpg;大小:2MB,建议比例<code>(200px:200px)</code>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <script id="content" name="content" class="required" type="text/plain" style="height:400px; z-index:998"></script>
                                    </div>
                                </div>
  ...
  <script type="text/javascript">
		$(function(){
            ...
            ue = UE.getEditor('content',{
            	"zIndex":0,
            	"serverUrl":"<?php echo U('Review/upload');?>",
            	});
