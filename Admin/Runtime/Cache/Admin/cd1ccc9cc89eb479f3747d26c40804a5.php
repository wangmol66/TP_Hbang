      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <ul class="page-breadcrumb breadcrumb">
            <li> <a href="javascript:void(0);"> 往期精彩回顾 </a> <i class="fa fa-angle-right"></i> </li>
  ...
  <script type="text/javascript">
		$(function(){
            ...
            $('.select-batch').change(function(){
                ...
                Smelly.confirmAlert("<?php echo U('ReviewLunbo/checked');?>",msg[type-1],{val:val,type:type},function(data){
                    console.log(data);
                });
