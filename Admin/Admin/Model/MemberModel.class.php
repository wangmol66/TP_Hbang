...
class MemberModel extends Model {
	...
	public $tbUser = 'wechat_user';
	public $tbExamModelLog = 'user_exam_model_log';
	public $tbUserClassesLinks = 'user_classes_links';
    ...
    public function getUserByIds($Uids = array()){
    	...
    	$tUA = M($this->tbUser)->where(array('uid'=>array('in',$Uids)))->select();
